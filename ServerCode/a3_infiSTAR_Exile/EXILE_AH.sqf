...
UPDATEEMAIL='peter.crimmings@gmail.com';
INFISTARVERSION='07-11-2018 11-17-51 - v93';
...
diag_log format['<infiSTAR.de> %1 - VERSION: 07-11-2018 11-17-51 - v93',time];
{
	_x params ['_uids'];
	{
		private _uid = _x;
...
if!(isClass (missionconfigfile >> 'RscListBox_infiSTAR'))exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_defines.hpp is not in your MPMission or you forgot to #include it within your description.ext   [31230x2 - 07-11-2018 11-17-51 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
if!(isClass (missionconfigfile >> 'infiSTAR_AdminMenu'))exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [31230x2 - 07-11-2018 11-17-51 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
if!(isClass (missionconfigfile >> 'infiSTAR_CHAT'))exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_chat.hpp is not in your MPMission or you forgot to #include it within your description.ext   [31230x2 - 07-11-2018 11-17-51 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
if!(isClass (missionconfigfile >> 'RscListBox_infiSTAR'))exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_KeyBinds.hpp is not in your MPMission or you forgot to #include it within your description.ext   [31230x2 - 07-11-2018 11-17-51 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
if!(getNumber(missionconfigfile >> 'infiSTAR_AdminMenu' >> 'version') isEqualTo 3)exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp in your MPMission is outdated. Update it or infiSTAR will not load.   [31230x2 - 07-11-2018 11-17-51 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
...
if(!("https://*" in _allowedHTMLLoadURIs) || !("http://*" in _allowedHTMLLoadURIs))exitWith{
	_log = format["<infiSTAR.de> %1 - infiSTAR_defines.hpp in your MPMission is outdated. Update it or infiSTAR will not load.   [31230x2 - 07-11-2018 11-17-51 - v93 - %2 - %3]",time,serverName,productVersion];
	diag_log _log;
	["MPMission_ERROR",_log] call FNC_A3_CUSTOMLOG;
};
...
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!   [31230x2 - 07-11-2018 11-17-51 - v93 - %2 - %3]',time,serverName,productVersion];
...
_fnc_RandomGen = {
	...
	_fnc_actualGen = {
		...
		_main	= ['a','8','5','8','4','e','a','9','6','f','5','f','1','2','6','5','7','9','f','5','0','5','b','5','2','3','6','4','c','5','8','9','0'];
...
_m = missionNamespace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=15615';missionNamespace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
...
_bigInputArray pushBack [
	[_name,_uid,_AHKickLog,_AHKickOFF,_admins,_admin,_isNormal,_server_classes],
	{
		...
		_devLog = format['infiSTAR.de AHAT %1 - 07-11-2018 11-17-51 - v93 - server running: %2:31230x2',VERSIONCHECKRESULT,time call FN_GET_TIME_TIME];diag_log _devLog;
		"; if(!_HIDE_FROM_PLAYERS)then{ _asd = _asd + "
...
"; }; _asd = _asd + "
	...
	_log = format['%1(%2) | %3 | %4 [07-11-2018 11-17-51 - v93]',_name,_uid,_log,time call FN_GET_TIME_TIME];
