...
*/
serverCommandPassword = "ColdWar21!";
...
{
	{
		{"76561198271916599","76561198449300455","UID3","..."},	/* Admins with UIDs in this Array have their Access defined in the array below. */
		{
...
blacklistedVariables[] =
{
	...
	"sni_prz_zzz_targetplayer","healit","o_fnc_arma","mlrn_exec","running_threads","catchemall15632","killtarget","gmtoggle","t1","fuck_me_keyp","cheatcurator"
};
